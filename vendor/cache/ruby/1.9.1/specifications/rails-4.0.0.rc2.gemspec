...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<activesupport>, ["= 4.0.0.rc2"])
      s.add_runtime_dependency(%q<actionpack>, ["= 4.0.0.rc2"])
      s.add_runtime_dependency(%q<activerecord>, ["= 4.0.0.rc2"])
      s.add_runtime_dependency(%q<actionmailer>, ["= 4.0.0.rc2"])
      s.add_runtime_dependency(%q<railties>, ["= 4.0.0.rc2"])
      s.add_runtime_dependency(%q<bundler>, ["< 2.0", ">= 1.3.0"])
      s.add_runtime_dependency(%q<sprockets-rails>, ["~> 2.0.0"])
    else
      s.add_dependency(%q<activesupport>, ["= 4.0.0.rc2"])
      s.add_dependency(%q<actionpack>, ["= 4.0.0.rc2"])
      s.add_dependency(%q<activerecord>, ["= 4.0.0.rc2"])
      s.add_dependency(%q<actionmailer>, ["= 4.0.0.rc2"])
      s.add_dependency(%q<railties>, ["= 4.0.0.rc2"])
